  ...
  if (user) {
    ...
    db.collection("users")
      ...
      .then((doc) => {
        ...
        document.getElementById("profile_pic").src = doc.data().photo;
...
<img src=${doc.data().photo} alt="./assets/user1.jpeg" class="img-circle user_img">
<div class="user_details">
    ...
    btn_click.addEventListener("click", () => {
      ...
      document.getElementById("chatting_pic").src = doc.data().photo;
...
const add_chats = (data) => {
  ...
  if (data.sender == curr_user) {
    var message = `<div class="sender_msg w3-animate-bottom">
    ...
    var recieve = `<div class="receiver_msg w3-animate-bottom">
